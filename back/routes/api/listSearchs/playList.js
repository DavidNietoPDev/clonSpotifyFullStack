...
router.get('/:playlist_id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
function handleSpotifyRequest(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try { // Función para hacer la petición a spotify de búsqueda de artista
            const playlist_id = req.params.playlist_id;
            const urlSpotifyPlaylist = `${process.env.urlSpotifyPlaylist}/${playlist_id}`;
            const tokenSpotify = process.env.SPOTIFY_ACCESS_TOKEN || '';
            if (!playlist_id) {
                return res.status(400).json({ error: 'ID de playlist no proporcionado' });
            }
            const responseSpotify = yield axios_1.default.get(urlSpotifyPlaylist, {
                headers: {
